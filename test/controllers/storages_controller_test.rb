...
class StoragesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create storage" do
    assert_difference("Storage.count") do
      post storages_url, params: { storage: { ip_id: @storage.ip_id, location_id: @storage.location_id, name: @storage.name } }
    end
  ...
  test "should update storage" do
    patch storage_url(@storage), params: { storage: { ip_id: @storage.ip_id, location_id: @storage.location_id, name: @storage.name } }
